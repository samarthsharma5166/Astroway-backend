                ...
                <div class="col-md-6">
                    ...
                    <div class="login-offer-bg">
                        <p class="text-white font-22 text-center font-weight-bold p-0 m-0 offertxt1"> <img
                                src="{{ asset($logo->value) }}" alt="{{ $appName->value }}" class="img-fluid mb-2 mr-3"
...
$(document).ready(function () {
    ...
    $('#verifyOtpBtn').click(function () {
        ...
        if (mobile === "9797979797" || mobile === "9898989898") {
            if (otpCode === "111111") {
                verifyBackendAstroLogin(mobile, countryCode, otpCode);
            } else {
    ...
    function verifyBackendAstroLogin(mobile, countryCode, otpCode) {
        $.ajax({
