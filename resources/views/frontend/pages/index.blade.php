                    ...
                    <div class="col-md-4 mb-4">
                        <div class="vedic-card"
                            ...
                            <span class="vedic-product-img" style="mask-image: linear-gradient(white, white, transparent);">
                                <img class="vedic-image mb-3" style="max-width: 100%; height: 200px; object-fit: contain;" src="{{ Str::startsWith($product->productImage, ['http://','https://']) ? $product->productImage : '/' . $product->productImage }}" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="Customer image" onclick="openImage('{{ $product->productImage }}')" />
                            </span>
                        ...
                        <a href="{{ route('front.getBlogDetails', ['slug' => $bloglist->slug]) }}" class="text-decoration-none">
                            <div class="product-card parad-shivling shadow-sm overflow-hidden p-0">
                                <div class="position-relative" style="height:250px;">
                                    <img class="product-image position-absolute" style="top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;" src="{{ Str::startsWith($bloglist->blogImage, ['http://','https://']) ? $bloglist->blogImage : '/' . $bloglist->blogImage }}" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="Customer image" onclick="openImage('{{ $bloglist->blogImage }}')" />
                                </div>
                                <div class="p-3 text-left">
                                    <h3 class="font-weight-700">{{$bloglist->title}}</h3>
                                    <p class="text-dark">
                                         {!! \Illuminate\Support\Str::words(strip_tags($bloglist->description), 15) !!}
                                    </p>
