                        ...
                        <div class="col-lg-12 col-12 ">
                            <div class="mb-3 ">
                                ...
                                <form class="px-3 font-14" method="post" id="callintakeForm">
                                    ...
                                    <input type="hidden" name="astrologerId" id="astroId" value="{{ $getAstrologer['recordList'][0]['id'] }}">
                    ...
                    <ul class="list-inline psychic-badge text-center text-md-right mb-0">
                        <li class="list-inline-item mt-sm-2 mt-md-0">
                            <div class="profile-buttons d-block align-items-center justify-content-center ">
                                ...
                                <div class="my-2 position-relative">
                                    <a class="btn-block  colorblack btn-audio-call btn-chat-profile @if($getAstrologer['recordList'][0]['callStatus']=='Busy') expert-busy @else expert-offline @endif ">
                                        <span class="d-flex w-100 justify-content-between">
                                            <span class="position-relative">
                                ...
                                <div class="my-2 position-relative">
                                    <a class="btn-block  colorblack btn-video-call btn-chat-profile @if($getAstrologer['recordList'][0]['callStatus']=='Busy') expert-busy @else expert-offline @endif ">
                                        <span class="d-flex w-100 justify-content-between">
                                            <span class="position-relative">
                                            ...
                                            @else
                                                <span class="d-block font-16">
                                                    ...
                                                    @else
                                                        {{ $currency['value'] }}
                                                    @endif
                                                    {{ $getAstrologer['recordList'][0]['videoCallRate'] }}/Min
                                                </span>
                                            @endif
                                        </span>
                                    </a>
