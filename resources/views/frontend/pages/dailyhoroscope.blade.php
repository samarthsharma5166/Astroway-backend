                ...
                <div class="col-sm-12">
                    <ul class="list-unstyled d-flex mb-3 mt-20" style="overflow-x: auto; white-space: nowrap; -webkit-overflow-scrolling: touch; scrollbar-width: none; -ms-overflow-style: none;">
                        @foreach ($gethoroscopesign['recordList'] as $horoscopesign)
                            <li class="px-2" style="flex: 0 0 auto;">
                                <a href="{{ route('front.dailyHoroscope', ['slug' => $horoscopesign['slug']]) }}"
                                    ...
                                    <div class="text-center mb-2 mb-md-0">
                                        <div class="icon border-0 bg-pink" style="width: 60px; height: 60px; margin: 0 auto; border-radius: 50%; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                                            <img class="cursor-pointer" src="{{ Str::startsWith($horoscopesign['image'], ['http://','https://']) ? $horoscopesign['image'] : '/' . $horoscopesign['image'] }}" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="{{ $horoscopesign['name'] }}" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;" />
                                        </div>
                                        <span class="d-block icon-desc pt-1" style="font-size: 12px;">{{ $horoscopesign['name'] }}</span>
                                    </div>
                                </a>
                            </li>
                        @endforeach
                    ...
                    <div class="row pt-2">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="col-12 pt-4 mt-3 tab-pane fade show active" id="dailyData">
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-center align-items-md-start">
                                    <div class="mb-3 mb-md-0 mr-md-4">
                                        <img class="cursor-pointer" src="{{ Str::startsWith($signRcd[0]->image, ['http://','https://']) ? $signRcd[0]->image : '/' . $signRcd[0]->image }}" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="{{ $horoscope['vedicList']['todayHoroscope'][0]['zodiac'] }}" onclick="openImage('{{ $signRcd[0]->image }}')" style="width: 150px; height: 150px; object-fit: cover; border-radius: 50%; border: 4px solid #6b1a4f; box-shadow: 0 4px 10px rgba(0,0,0,0.1);" />
                                    </div>
                                    <div class="media-body w-100 text-center text-md-left">
                                        <div class="dailyhoroscope-content mt-1">
                                            <p style="font-weight: 700; font-size: 1.1rem;">Free {{ $horoscope['vedicList']['todayHoroscope'][0]['zodiac'] }} Daily
                                                Horoscope
                                            </p>
                            ...
                            <div class="col-12 pt-4 mt-3 tab-pane fade" id="weeklyData">
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-center align-items-md-start">
                                    <div class="mb-3 mb-md-0 mr-md-4">
                                        <img class="cursor-pointer" src="{{ Str::startsWith($signRcd[0]->image, ['http://','https://']) ? $signRcd[0]->image : '/' . $signRcd[0]->image }}" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="{{ $horoscope['vedicList']['weeklyHoroScope'][0]['zodiac'] }}" onclick="openImage('{{ $signRcd[0]->image }}')" style="width: 150px; height: 150px; object-fit: cover; border-radius: 50%; border: 4px solid #6b1a4f; box-shadow: 0 4px 10px rgba(0,0,0,0.1);" />
                                    </div>
                                    <div class="media-body w-100 text-center text-md-left">
                                        <div class="dailyhoroscope-content mt-1">
                                            <p style="font-weight: 700; font-size: 1.1rem;">Free {{ $horoscope['vedicList']['weeklyHoroScope'][0]['zodiac'] }} Weekly
                                                Horoscope
                                            </p>
                            ...
                            <div class="col-12 pt-4 mt-3 tab-pane fade " id="yearlyData">
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-center align-items-md-start">
                                    <div class="mb-3 mb-md-0 mr-md-4">
                                        <img class="cursor-pointer" src="{{ Str::startsWith($signRcd[0]->image, ['http://','https://']) ? $signRcd[0]->image : '/' . $signRcd[0]->image }}" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="{{ $horoscope['vedicList']['yearlyHoroScope'][0]['zodiac'] }}" onclick="openImage('{{ $signRcd[0]->image }}')" style="width: 150px; height: 150px; object-fit: cover; border-radius: 50%; border: 4px solid #6b1a4f; box-shadow: 0 4px 10px rgba(0,0,0,0.1);" />
                                    </div>
                                    <div class="media-body w-100 text-center text-md-left">
                                        <div class="dailyhoroscope-content mt-1">
                                            <p style="font-weight: 700; font-size: 1.1rem;">Free {{ $horoscope['vedicList']['yearlyHoroScope'][0]['zodiac'] }} Yearly
                                                Horoscope
                                            </p>
