                ...
                <div class="tab-content mt-5 editastrologertab">
                    <div id="example-tab-1" class="tab-pane leading-relaxed active" role="tabpanel"
                        ...
                        <div class="input">
                            <div>
                                ...
                                <label for="regular-form-1" class="form-label">Name {!! requiredField() !!}</label>
                        ...
                        <div class="input mt-3">
                            <div>
                                <label for="regular-form-1" class="form-label">Email {!! requiredField() !!}</label>
                        ...
                        <div class="intro-y grid grid-cols-12 gap-6 mt-5">
                            <div class="intro-y col-span-6 md:col-span-6">
                                <div class="input mt-3">
                                    <label for="regular-form-1" class="form-label">Mobile Number {!! requiredField() !!}</label>
                                        <div class="input-group">
                                            <input type="text" id="countryCode1" value="+91" placeholder="+91" name="countryCode"
                            ...
                            <div class="intro-y col-span-6 md:col-span-6">
                                <div class="input mt-3">
                                    <div>
                                        <label for="title" class="form-label">Country {!! requiredField() !!}</label>
                            ...
                            <div class="intro-y col-span-6 md:col-span-6">
                                <div class="input mt-3">
                                    <div>
                                        <label for="regular-form-1" class="form-label">Aadhar Number {!! requiredField() !!}</label>
                            ...
                            <div class="intro-y col-span-6 md:col-span-6">
                                <div class="input mt-3">
                                    <div>
                                        <label for="regular-form-1" class="form-label">Pan Number {!! requiredField() !!}</label>
                            ...
                            <div class="intro-y col-span-6 md:col-span-6">
                                <div>
                                    <label for="profile" class="form-label">Profile Image {!! requiredField() !!}</label>
                    ...
                    <div id="example-tab-2" class="tab-pane leading-relaxed" role="tabpanel"
                        ...
                        <div class="intro-y grid grid-cols-12 gap-6 mt-5">
                            <div class="intro-y col-span-6 md:col-span-6">
                                <div class="input mt-3">
                                    <div>
                                        <label for="title" class="form-label">Select Gender {!! requiredField() !!}</label>
                            ...
                            <div class="intro-y col-span-6 md:col-span-6">
                                <div class="input mt-3">
                                    <div>
                                        <label id="input-group" class="form-label">Birth Date {!! requiredField() !!}</label>
                            ...
                            <div class="intro-y col-span-6 md:col-span-6">
                                <div class="preview mt-3">
                                    <label for="title" class="form-label">{{ucfirst($professionTitle)}} Category {!! requiredField() !!}</label>
                            ...
                            <div class="intro-y col-span-6 md:col-span-6">
                                <div class="preview mt-3">
                                    <label for="title" class="form-label">Primary Skills {!! requiredField() !!}</label>
                            ...
                            <div class="intro-y col-span-6 md:col-span-6">
                                <div class="preview mt-3">
                                    <label for="title" class="form-label">All Skills {!! requiredField() !!}</label>
                            ...
                            <div class="intro-y col-span-6 md:col-span-6">
                                <div class="preview mt-3">
                                    <label for="title" class="form-label">Language {!! requiredField() !!}</label>
                             ...
                             <div class="input mt-3">
                                    <div>
                                        <label for="regular-form-1" class="form-label">Add Your Charge(As per
                                            Minute In INR) {!! requiredField() !!}</label>
                    ...
                    <div class="intro-y grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="intro-y col-span-6 md:col-span-6">
                            <div class="input mt-3">
                                <div>
                                    <label for="regular-form-1" class="form-label">IFSC Code {!! requiredField() !!}</label>
                                    <input
                        ...
                        <div class="intro-y col-span-6 md:col-span-6">
                            <div class="input mt-3">
                                <div>
                                    <label for="regular-form-1" class="form-label">Bank Name {!! requiredField() !!}</label>
                                    <input
                        ...
                        <div class="intro-y col-span-6 md:col-span-6">
                            <div class="input mt-3">
                                <div>
                                    <label for="regular-form-1" class="form-label">Bank Branch {!! requiredField() !!}</label>
                                    <input
                        ...
                        <div class="intro-y col-span-6 md:col-span-6">
                            <div class="input mt-3">
                                <div>
                                    <label for="regular-form-1" class="form-label">Account Type {!! requiredField() !!}</label>
                        ...
                        <div class="intro-y col-span-6 md:col-span-6">
                            <div class="input mt-3">
                                <div>
                                    <label for="regular-form-1" class="form-label">Bank Account Number {!! requiredField() !!}</label>
                        ...
                        {{-- <div class="intro-y col-span-6 md:col-span-6">
                            <div class="input mt-3">
                                <div>
                                    <label for="regular-form-1" class="form-label">Confirm Bank Account Number {!! requiredField() !!}</label>
                                    <input inputmode="numeric"
                        ...
                        <div class="intro-y col-span-6 md:col-span-6">
                            <div class="input mt-3">
                                <div>
                                    <label for="regular-form-1" class="form-label">Account Holder Name {!! requiredField() !!}</label>
                                    <input
                    ...
                    <div id="example-tab-4" class="tab-pane leading-relaxed" role="tabpanel"
                        ...
                        <div class="intro-y grid grid-cols-12 gap-6 mt-5">
                            ...
                            <div class="intro-y col-span-6 md:col-span-6">
                                <div class="preview mt-3">
                                    <label for="title" class="form-label">Select your highest qualification {!! requiredField() !!}</label>
                                ...
                                <div class="input mt-3">
                                    <div>
                                        <label for="regular-form-1" class="form-label">Minimum Earning Expection from
                                            {{ucfirst($appname)}} {!! requiredField() !!}</label>
                            ...
                            <div class="intro-y col-span-6 md:col-span-6">
                                <div class="input mt-3">
                                    <div>
                                        <label for="regular-form-1" class="form-label">Long bio {!! requiredField() !!}</label>
                            ...
                            <div class="intro-y col-span-6 md:col-span-6">
                                <div class="preview mt-3">
                                    <label for="title" class="form-label">Number of the foreign countries you
                                        lived/travelled to? {!! requiredField() !!}</label>
                                ...
                                <div class="input mt-3">
                                    <div>
                                        <label for="regular-form-1" class="form-label">What are some good qualities of
                                            perfect
                                            {{$professionTitle}}? {!! requiredField() !!}</label>
                                ...
                                <div class="input mt-3">
                                    <div>
                                        <label for="regular-form-1" class="form-label">What was the biggest challenge you
                                            faced and how did you overcome it? {!! requiredField() !!}</label>
                                ...
                                <div class="input mt-3">
                                    <div>
                                        <label for="regular-form-1" class="form-label">A customer is asking the same
                                            question
                                            repeatedly: what will you do? {!! requiredField() !!}</label>
...
@section('script')
    ...
    <script>
        ...
        jQuery('#addastrologer').submit(function(e) {
            ...
            if (wordCount < 50) {
                toastr.error('Long Bio must be at least 50 words.');
                spinner.hide();
                return false;
            }
