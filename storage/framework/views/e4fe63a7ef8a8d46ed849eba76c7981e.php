        ...
        <table class="table table-report mt-2" aria-label="customer-list">
            ...
            <tbody id="todo-list">
                <?php
                    $no = 0;
                ?>
                <?php $__currentLoopData = $pujalist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $puja): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr class="intro-x">
                ...
                <div class="image-fit zoom-in" style="height:2.3rem;width:2.3rem;">
                    ...
                    <?php if($firstImage): ?>
                        <img class="rounded-full cursor-pointer"
                             src="<?php echo e(Str::startsWith( $firstImage, ['http://','https://']) ? $firstImage : '/' . $firstImage); ?>"
                             onerror="this.onerror=null;this.src='/build/assets/images/person.png';"
                             alt="Customer image"
                             onclick="openImage('<?php echo e(Str::startsWith( $firstImage, ['http://','https://']) ? $firstImage : '/' . $firstImage); ?>')" />
                    <?php else: ?>
        ...
        <td>
            <div class="font-medium whitespace-nowrap"><?php echo e($puja->puja_title ? $puja->puja_title : '--'); ?></div>
        </td>
        <td class="text-center"><?php echo e($puja->puja_subtitle ? $puja->puja_subtitle : '--'); ?></td>
        <td class="text-center"><?php echo e($puja->puja_place ? $puja->puja_place : '--'); ?></td>
        <td class="text-center">
            <div class="flex justify-center items-center">
                <div class="form-check form-switch justify-center w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0 mr-3">
                    <input class="toggle-class show-code form-check-input mr-3 ml-3" type="checkbox"
                        ...
                        <?php echo e($puja->puja_status ? 'checked' : ''); ?>

                        onclick="editPuja(<?php echo e($puja->id); ?>,<?php echo e($puja->puja_status); ?>)"
        ...
        <td class="table-report__action w-56">
            <div class="flex justify-center items-center">
                <a class="flex items-center mr-3" href="<?php echo e(route('edit-puja', $puja->id)); ?>">
                    <i data-lucide="check-square" class="w-4 h-4 mr-1"></i>Edit
                </a>
                <a type="button" href="javascript:;" class="flex items-center deletebtn text-danger"
                    data-tw-toggle="modal" data-tw-target="#deleteModal" onclick="delbtn(<?php echo e($puja->id); ?>)">
                    <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i>Delete
                </a>
                <a class="flex items-center ml-3" href="<?php echo e(route('view-puja', $puja->id)); ?>">
                    <i data-lucide="eye" class="w-4 h-4 mr-1"></i>View
                </a>
            </div>
        </td>
        <td class="text-center">
            <?php if($puja->puja_start_datetime && \Carbon\Carbon::now()->gt(\Carbon\Carbon::parse($puja->puja_start_datetime))): ?>
...
<div class="image-overlay" id="imageOverlay">
    ...
    <?php if($totalRecords > 0): ?>
        <div class="d-inline text-slate-500 pagecount">Showing <?php echo e($start); ?> to <?php echo e($end); ?> of
            <?php echo e($totalRecords); ?> entries
        </div>
    <?php endif; ?>
        ...
        <nav class="w-full sm:w-auto sm:mr-auto">
            <ul class="pagination">
                <li class="page-item <?php echo e($page == 1 ? 'disabled' : ''); ?>">
                    <a class="page-link" href="<?php echo e(route('puja-list', ['page' => $page - 1])); ?>">
                        <i class="w-4 h-4" data-lucide="chevron-left"></i>
                    </a>
                </li>
                <?php for($i = 0; $i < $totalPages; $i++): ?>
                    <li class="page-item <?php echo e($page == $i + 1 ? 'active' : ''); ?> ">
                        <a class="page-link" href="<?php echo e(route('puja-list', ['page' => $i + 1])); ?>"><?php echo e($i + 1); ?></a>
                    </li>
                <?php endfor; ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body p-0">
                ...
                <form action="<?php echo e(route('deletePuja')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('PujaStatus')); ?>" method="POST"
