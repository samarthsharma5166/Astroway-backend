                        ...
                        <div class="col-12 mb-4">
                            ...
                            <div>
                                <p class="pt-3 text-center">Anytime Astro is a premium online horoscope-matching site that
                                    ...
                                    <?php echo e($professionTitle); ?>s analyze the compatibility of both the partners and present accurate results
                ...
                <div class="col-12">
                    ...
                    <div>
                        <p class="pt-3 text-center">Got the Patrika Matching analysis, but not sure about what it means.
                            Rest assured, connect with expert<?php echo e($professionTitle); ?>s instantly over call or chat to ensure minute
                            details about your compatibility and also receive recommendations to fix any issues that might
                            hinder in marital life.</p>
                        <p class="text-center">Connect with <?php echo e($professionTitle); ?>s now!</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <p><b>Step 4:</b> Based on the scores of each guna, the compatibility gets calculated. The higher the
                        ...
                        while analyzing, which can be done by expert <?php echo e(ucfirst($professionTitle)); ?>s.</p>
                    ...
                    <p><b>Step 6:</b> It is recommended to consult expert <?php echo e(ucfirst($professionTitle)); ?>s for further clarifications and
                        insights.</p>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <ul>
                        ...
                        <?php echo e(ucfirst($professionTitle)); ?>s when you can do online kundali matching for marriage.</li>
                        <li>Online kundli matching for marriage helps you save a lot of time and effort, as you don't need
                            to travel to meet the <?php echo e($professionTitle); ?>s traditionally in person.</li>
                            ...
                            <div class="bg-gray looks-1 d-flex p-2 py-3 p-sm-3 overflow-hidden position-relative flex-column-reverse flex-sm-row">
                                ...
                                <div class="text-center d-flex align-items-center w-100 px-sm-4 pr-2 pr-sm-5">
                                    <div class="px-2 px-xl-5 w-100">
                                        ...
                                        <a href="<?php echo e(route('front.chatList')); ?>" class="btn btn-chat px-3 px-sm-4 font-small-ms mt-3">Ask An <?php echo e(ucfirst($professionTitle)); ?> Now</a>
                                    </div>
                                </div>
                                ...
                                <div class="looks-image ilook2 text-center position-relative align-items-center mr-md-3 mr-lg-4">
                                    <div class="looks-img-box position-relative">
                                        <img src="<?php echo e(asset('public/frontend/astrowaycdn/astroway/web/content/images/ads/indian-bride-ads.png')); ?>" alt="Indian Bride Image">
                                    </div>
                                </div>
                ...
                <div class="col-12 mb-5">
                    ...
                    <ul>
                        ...
                        <li>Based on the results, one can consult <?php echo e($professionTitle); ?>s to seek personalized guidance, yet clarifying
                            concerns. </li>
                    </ul>
                </div>
            </div>
