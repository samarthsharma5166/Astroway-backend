            ...
            <div class="d-flex align-items-center">
                ...
                <a class="text-decoration-none" href="<?php echo e(route('front.home')); ?>">
                    <div class="d-flex align-items-center ml-2">
                        ...
                        <img src="<?php echo e(asset($logo->value)); ?>" alt="<?php echo e($appName->value); ?>" class="img-fluid" width="50"
                            height="50">
                        ...
                        <div class="dropdown ">
                            <a class="btn dropdown-toggle p-0" role="button" id="dropdownMenuLink"
                                ...
                                <?php if(authcheck()['profile']): ?>
                                    <img src="<?php echo e(asset(authcheck()['profile'])); ?>" alt="User" class="img-fluid rounded" style="height: 50px;width:50px">
                                <?php else: ?>
                                        ...
                                        <div>
                                            <a class="dropdown-item d-flex justify-content-between align-items-center pr-2"
                                                ...
                                                <span>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php echo e(number_format($userWalletAmount, 2)); ?></span>
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle font-weight-semi-bold nav-link-mobile" href="#"
                            ...
                            aria-expanded="false">
                            <img src="<?php echo e(asset($freekundali->value)); ?>" alt="" height="20" width="20">
                            Kundali
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link font-weight-semi-bold nav-link-mobile"
                            href="<?php echo e(route('front.getPanchang')); ?>"><img src="<?php echo e(asset($panchang->value)); ?>"
                                alt="" height="20" width="20"> Panchang</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link font-weight-semi-bold nav-link-mobile"
                            href="<?php echo e(route('front.pujaCategory')); ?>"><img src="<?php echo e(asset($puja->value)); ?>" alt=""
                    ...
                    <li class="nav-item">
                        <a class="nav-link font-weight-semi-bold nav-link-mobile"
                            href="<?php echo e(route('front.horoScope')); ?>"><img src="<?php echo e(asset($daily_horoscope->value)); ?>"
                                alt="" height="20" width="20"> Horoscope</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link font-weight-semi-bold nav-link-mobile"
                            href="<?php echo e(route('front.getproducts')); ?>"><img src="<?php echo e(asset($shop->value)); ?>" alt=""
                                height="20" width="20"> Shop</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link font-weight-semi-bold nav-link-mobile"
                            href="<?php echo e(route('front.getBlog')); ?>"><img src="<?php echo e(asset($blog->value)); ?>" alt=""
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center pb-5 px-4">
                ...
                <div class="d-flex flex-column gap-2">
                    <a href="<?php echo e(route('front.astrologerlogin')); ?>" class="btn btn-chat w-100 py-3 font-weight-bold">
...
<?php /**PATH /Users/samarthsharma/Documents/codecanyon-50933419-astroway-astrology-consultation-app-with-php-backend-audiovideo-calls-chat-with-live-streaming/Backend/resources/views/frontend/layout/header.blade.php ENDPATH**/ ?>