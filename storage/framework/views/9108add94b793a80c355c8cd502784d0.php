                ...
                <div class="col-12 d-flex align-items-center">
                    <span style="text-transform: capitalize;">
                        <span class="text-white breadcrumbs">
                            ...
                            <a href="<?php echo e(route('front.pujaList',$puja->category_id)); ?>" class="text-white text-decoration-none">Puja</a>
                            <i class="fa fa-chevron-right"></i>
                            Puja Details - <?php echo e($puja->puja_title); ?>
        ...
        <div class="bg-white rounded-3 shadow p-4 d-flex flex-column flex-md-row gap-4">
            ...
            <div class="col-md-6 d-flex flex-column align-items-center">
                <div class="w-100 border rounded overflow-hidden" style="height: 400px;">
                    <?php $__currentLoopData = $puja->puja_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <img id="mainImage" class="w-100 h-100 object-fit-cover transition-all" 
                             src="<?php echo e(Str::startsWith($image, ['http://','https://']) ? $image : '/' . $image); ?>" 
            ...
            <div class="col-md-6 d-flex flex-column ">
                <div>
                    <h2 class="h3 fw-bold mb-2"><?php echo e($puja->category->name); ?></h2>
                    <h4 class="text-muted mb-1"><?php echo e($puja->puja_title); ?></h4>
                    <h5 class="text-muted mb-2"><?php echo e($puja->puja_subtitle); ?></h5>
                    <strong class="text-secondary mb-4 d-block"><?php echo e($puja->puja_place); ?></strong>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <span class="badge bg-primary fs-6 py-2 px-3">
                            <?php if($sameDate): ?>
                                <?php echo e($startDateDisplay); ?> <?php echo e($startTimeDisplay); ?> - <?php echo e($endTimeDisplay); ?>

                            <?php else: ?>
                                <?php echo e($startDateDisplay); ?> <?php echo e($startTimeDisplay); ?> to <?php echo e($endDateDisplay); ?> <?php echo e($endTimeDisplay); ?>
                    ...
                    <?php if($isFutureEvent): ?>
                        <div class="countdown-timer mt-2" 
                             data-start-datetime="<?php echo e($startDatetime->toIso8601String()); ?>">
                ...
                <a href="#packages" id="selectPackageBtn" class="btn btn-outline-primary mt-5 w-100 mt-4 fw-semibold d-flex justify-content-center align-items-center">
  ...
  <div class="tab-content mt-4">
    ...
    <div id="about" class="section active">
      ...
      <p class="text-justify">
        <?php echo e($puja->long_description ?? 'Detailed description about the Puja will appear here.'); ?>
    ...
    <div id="benefits" class="section">
      <h2>Puja Benefits</h2>
      <div class="row mt-4">
        <?php $__currentLoopData = $puja->puja_benefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-md-4 mb-3">
          <div class="d-flex">
            ...
            <div>
              <h6 class="fw-bold"><?php echo e($benefit['title']); ?></h6>
              <p class="text-muted mb-0"><?php echo e($benefit['description']); ?></p>
            </div>
          </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div id="packages" class="section">
      ...
      <div class="row mt-4">
        <?php $__currentLoopData = $package; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $packageDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-md-4 mb-3">
          <div class="card shadow-sm border-warning h-100">
            <div class="card-body text-center">
              <h4 class="text-warning"><?php echo e($packageDetail['title']); ?></h4>
              <p class="mb-1 text-muted">For <?php echo e($packageDetail['person']); ?> Person</p>
              <h3 class="fw-bold text-danger">
                ...
                <?php endif; ?>
              <?php echo e($packageDetail['package_price']); ?></h3>
              <ul class="text-start mt-3 list-unstyled small">
                <?php $__currentLoopData = $packageDetail['description']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li><i class="fa-solid fa-hand-point-right text-warning"></i> <?php echo e($point); ?></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            </div>
            <div class="card-footer bg-transparent border-top-0 text-center pb-3">
              <a <?php if(!authcheck()): ?> data-toggle="modal" data-target="#loginSignUp" <?php else: ?> href="<?php echo e(route('front.pujaAstrologerList',['slug'=>$puja->slug,'package_id'=>$packageDetail['id']])); ?>" <?php endif; ?> class="btn btn-success w-75">Participate</a>
            </div>
          </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div id="faqs" class="section">
      ...
      <div class="accordion" id="faqAccordion">
        <?php $__currentLoopData = $FAQ; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faqItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="accordion-item">
          <h2 class="accordion-header" id="heading<?php echo e($index); ?>">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo e($index); ?>" aria-expanded="false">
              <?php echo e($faqItem->title); ?>

            </button>
          </h2>
          <div id="collapse<?php echo e($index); ?>" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
