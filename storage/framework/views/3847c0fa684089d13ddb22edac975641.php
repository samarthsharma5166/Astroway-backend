                    ...
                    <div class="box">
                        <div class="p-5">
                            <div
                                ...
                                <img alt="Product image" class="rounded-md" src="<?php echo e(Str::startsWith($productCat['categoryImage'], ['http://','https://']) ? $productCat['categoryImage'] : '/' . $productCat['categoryImage']); ?>">
