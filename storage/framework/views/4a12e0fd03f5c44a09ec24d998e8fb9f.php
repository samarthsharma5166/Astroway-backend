<?php $__env->startSection('subhead'); ?>
    <title><?php echo e(ucfirst($professionTitle)); ?> Category</title>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('subcontent'); ?>
    <div class="loader"></div>
    <h2 class="intro-y text-lg font-medium mt-10 d-inline"><?php echo e(ucfirst($professionTitle)); ?> Categories</h2>
    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-gift"
        ...
        <?php echo e(ucfirst($professionTitle)); ?> Category</a>
                            ...
                            <td>
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                     ...
                                     src="<?php echo e(Str::startsWith($astroCat['image'], ['http://','https://']) ? $astroCat['image'] : '/' . $astroCat['image']); ?>"
                                     onerror="this.onerror=null;this.src='/build/assets/images/person.png';"
                                     alt="Customer image"
                                     onclick="openImage('<?php echo e(Str::startsWith($astroCat['image'], ['http://','https://']) ? $astroCat['image'] : '/' . $astroCat['image']); ?>')" />
                                    </div>
                                </div>
                            </td> 
                            <td>
...
<div class="image-overlay" id="imageOverlay">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Add <?php echo e(ucfirst($professionTitle)); ?> Category</h2>
                </div>
                <form id="add-data" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="input" class="p-5">
                        <div class="preview">
                            ...
                            <div class="mt-5"><button class="btn btn-submit btn-primary shadow-md mr-2">Add <?php echo e(ucfirst($professionTitle)); ?>
    ...
    <div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Edit <?php echo e(ucfirst($professionTitle)); ?> Category</h2>
                </div>
