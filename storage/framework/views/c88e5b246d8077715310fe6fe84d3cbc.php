                                        ...
                                        <?php if($getkundaliprice['isFreeSession'] == false): ?>
                                            <div class="col-12 col-md-6 py-3">
                                                ...
                                                <select name="kundali[0][pdf_type]" onchange="updateAmount()" class="form-control font-14 border-pink text-dark shadow-none matchInTxt" id="pdf_type">
                                                    ...
                                                    <option value="small" data-price="<?php echo e($getkundaliprice['recordList']['0']['price']); ?>">Small 
                                                    ...
                                                    <?php endif; ?>
                                                    <?php echo e($getkundaliprice['recordList']['0']['price']); ?>)</option>
                                                    <option value="medium" data-price="<?php echo e($getkundaliprice['recordList']['1']['price']); ?>">Medium 
                                                       <?php if($walletType == 'coin'): ?>
                                                        <img src="<?php echo e(asset($coinIcon)); ?>" alt="Wallet Icon" width="15">
                                                    <?php else: ?>
                                                        <?php echo e($currency['value']); ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php echo e($getkundaliprice['recordList']['1']['price']); ?>)</option>
                                                    <option value="large" data-price="<?php echo e($getkundaliprice['recordList']['2']['price']); ?>">Large 
                                                       <?php if($walletType == 'coin'): ?>
                                                        <img src="<?php echo e(asset($coinIcon)); ?>" alt="Wallet Icon" width="15">
                                                    <?php else: ?>
                                                        <?php echo e($currency['value']); ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php echo e($getkundaliprice['recordList']['2']['price']); ?>)</option>
                                                </select>
                                                        ...
                                                        <div class="row mb-2">
                                                            <div class="col-10">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col pl-1">
                                                                        <a href="<?php echo e(route('front.kundaliReport', ['kundali_id' => $getkundali['id']])); ?>" class="colorblack">
                                                                            <p
                                                                                class="mb-0 font-13 font-weight-semi-bold small">
                                                                                Name : <?php echo e($getkundali['name']); ?></p>
                                                                            <p class="mb-0 font-12">
                                                                                Dob : <?php echo e(date("d-m-Y" ,strtotime($getkundali['birthDate']))); ?></p>
                                                                            <p class="mb-0 font-12">
                                                                                Pob :  <?php echo e($getkundali['birthPlace']); ?></p>
                                                                            <p class="mb-0 font-12">
                                                                            Created At : <?php echo e(date("d-m-Y" ,strtotime($getkundali['created_at']))); ?></p>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="bg-pink looks-1 d-flex p-2 py-3 p-sm-3 overflow-hidden position-relative">
                                        <div
                                            ...
                                            <div class="px-2 w-100">
                                                ...
                                                <span class="d-none d-md-block font-22 mt-3 pt-1">Ask an <?php echo e(ucfirst($professionTitle)); ?> now for
                                                    solutions.</span>

                                                <a href="<?php echo e(route('front.chatList')); ?>"
                                                    class="btn btn-chat px-3 px-sm-4 font-small-ms mt-3">Ask An <?php echo e(ucfirst($professionTitle)); ?>
            ...
            $('#showKundalibtn').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        let url = "<?php echo e(route('front.kundaliReport', ['kundali_id' => ''])); ?>";
