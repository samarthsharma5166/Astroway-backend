...
<head>
    ...
    <meta name="keywords"
        content="<?php echo e(ucfirst($appname)); ?> Admin Panel">
    <meta name="author" content="<?php echo e(ucfirst($appname)); ?>">
...
document.addEventListener("DOMContentLoaded", function () {
    const editorElement = document.querySelector('#edescription');
    ...
    ClassicEditor
        ...
        .then(editor => {
            window.editorInstance = editor; // global if needed
        })
        .catch(error => {
...
<?php /**PATH /Users/samarthsharma/Documents/codecanyon-50933419-astroway-astrology-consultation-app-with-php-backend-audiovideo-calls-chat-with-live-streaming/Backend/resources/views////layout/base.blade.php ENDPATH**/ ?>