    ...
    <div class="container mt-5 mb-5 pujalist-show">
        <?php $__currentLoopData = $pujalists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $puja): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="scard dark1">
                <img class="imgb" src="<?php echo e(Str::startsWith($firstImage, ['http://','https://']) ? $firstImage : '/' . $firstImage); ?>" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="Customer image" onclick="openImage('<?php echo e($firstImage); ?>')" />
                ...
                <div class="descrb">
                    <h3 class="mt-3 font-weight-bold"><?php echo e(\Illuminate\Support\Str::limit($puja->puja_title, 58, '...')); ?></h3>
                ...
                <div class="mt-2 d-flex align-items-start">
                    ...
                    <div>
                        <span class="d-block" style="font-size: 15px;"><?php echo e(\Illuminate\Support\Str::limit($puja->puja_place, 60, '...')); ?></span>
                    </div>
                </div>
                <div class="d-flex align-items-start mt-2">
                    ...
                    <div class="text-white">
                        <div class="text-gray-90 mt-1">
                            ...
                            <?php echo e($startDatetime && $endDatetime ? ($sameDate ? $startDateDisplay.' '.$startTimeDisplay : $startDateDisplay.' '.$startTimeDisplay.' '.$endTimeDisplay) : 'Date not available'); ?></span>
                        </div>
                    </div>
                </div>
                <div><hr></div>
                <div class="puja-footer">
                    <a href="<?php echo e(route('front.pujaDetails', $puja->slug)); ?>" class="read w-100">
