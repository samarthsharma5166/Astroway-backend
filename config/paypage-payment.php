    ...
    'payments' => [
        ...
        'gateway_configuration' => [
            ...
            'stripe'    => [
                ...
                'stripeTestingSecretKey'    => env('STRIPE_TESTING_SECRET_KEY', 'Enter your Test Secret Key'), //Stripe testing Secret Key
                'stripeTestingPublishKey'   => env('STRIPE_TESTING_PUBLISH_KEY', 'Enter your Test Publish Key'), //Stripe testing Publish Key
                'stripeLiveSecretKey'       => env('STRIPE_LIVE_SECRET_KEY', 'Enter your Live Secret Key'), //Stripe Secret live Key
                'stripeLivePublishKey'      => env('STRIPE_LIVE_PUBLISH_KEY', 'Enter your Live Publish Key'), //Stripe live Publish Key
                'callbackUrl'               => "payment-response", //callback Url after payment successful
                'privateItems'              => [
